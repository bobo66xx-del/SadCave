...
**Status:** 🟢 Shipped on baseline + Brief B 🟢 Shipped (PR #27 merged 2026-04-30 04:38:32 UTC, branch `codex/title-polish-brief-b`, head `d3c6958`) + **Aura Pass ⚫ Scrapped 2026-04-30** (Stillness Bloom design specced 2026-04-29 session_5; Codex implementation on `codex/nametag-aura-pass` commit `63090ce` rendered as a giant dark slab in playtest — root cause was the dark-cushion-as-legibility-base design call, not implementation; branch reverted end-to-end; Tyler scrapped rather than redesigned, project on hiatus. Aura Pass design section below kept as historical record — see `_Decisions.md` 2026-04-30 + `07_Sessions/2026-04-30_session_1.md`).
